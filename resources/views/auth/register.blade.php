<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="national_id" class="block mt-1 w-full" type="text" name="national_id" :value="old('national_id')" autocomplete="national-id" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="driver_license_number" class="block mt-1 w-full" type="text" name="driver_license_number" :value="old('driver_license_number')" autocomplete="license-number" />
